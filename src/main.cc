...
int main() {
    ...
    Shader shader = Shader("./resources/triangle.vert",
    ...
    projection = glm::perspective(glm::radians(45.0f), (float)width_window / (float)height_window, 0.1f, 100.0f);
